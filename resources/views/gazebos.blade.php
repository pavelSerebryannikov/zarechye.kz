...
<main>
    ...
    <div class="container mt-5 about_block">
        ...
        <div class="row justify-content-center mt-4 concept_benefits">
            @foreach($benefits->where('place', 'gazebos') as $benefit)
                <div class="col-md-4 col-lg-3">
                    <div class="benefit">
                        <picture data-src="{{ $benefit->webpImage }}">
                            <source srcset="{{ $benefit->webpImage }}" type="image/webp">
                            <source srcset="{{ \Voyager::image($benefit->image) }}" type="image/pjpeg">
