...
<?php if(strpos($path['path'], "/bronirovanie") === false && strpos($path['path'], "/booking-services") === false): ?>
<script>
        (function(w,d,u){
...
<?php /**PATH /var/www/vhosts/zarechye.kz/httpdocs/resources/views/partials/scripts.blade.php ENDPATH**/ ?>