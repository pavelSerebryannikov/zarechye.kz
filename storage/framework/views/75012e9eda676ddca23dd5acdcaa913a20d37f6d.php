...
<main>
    ...
    <div class="container mt-5 inner_text">
        <div class="row justify-content-center promo">
            <?php $__currentLoopData = $promotions->where('type', 'second'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $promotion): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('partials.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/zarechye.kz/httpdocs/resources/views/banya.blade.php ENDPATH**/ ?>